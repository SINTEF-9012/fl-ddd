...
traind = data_generate_training.flow_from_directory("A",
                                          target_size = (227, 227),
                                          #seed = 123,
                                          shuffle=True,
                                          batch_size = 32,
...
testd = data_generate_training.flow_from_directory("A",
                                          target_size = (227, 227),
                                          #seed = 123,
                                          shuffle=True,
                                          batch_size = 32,
...
class CifarClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        self.model.fit(data_generate_training.flow(self.traind, batch_size=32), epochs=1)
